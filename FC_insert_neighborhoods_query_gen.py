...
with open('read_files/FC_neighborhoods_with_nodes.csv','r') as in_file: # SELECT input file
	read_file = csv.reader(in_file)
	next(read_file)

	database = 'FC_COL_WRT..DLocations'

	with open('queries/FC_insert_neighborhoods.sql','w') as output: # SELECT output file
